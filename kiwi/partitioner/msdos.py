...
class PartitionerMsDos(PartitionerBase):
    ...
    **Implement old style msdos partition setup**
    ...
    def create(
        ...
        :param int explicit_partition_id: If provided, use this exact partition ID
                                         instead of auto-incrementing. Presence of
                                         explicit_partition_id indicates custom_part_control
                                         is enabled, which means user has explicit control
                                         over partition layout. In this case, extended_layout
                                         logic is bypassed.
        """
